...
export default function MultiStepForm({ langue, setLangue, direction }) {
  ...
  useEffect(() => {
    const checkAuth = async () => {
      try {
        ...
        setError(
          translations[langue].required.replace(
            ":attribute",
            "authentification"
          )
        );
  ...
  useEffect(() => {
    const fetchWilayas = async () => {
      try {
        ...
        setWilayasError(
          translations[langue].required.replace(":attribute", "wilayas")
        );
        setIsLoadingWilayas(false);
      }
    };
  ...
  const validateStep1 = () => {
    if (!step1Data.id_nin_personne) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].id_nin_personne
        )
      );
      return false;
    }
    ...
    if (!step1Data.nom_personne_fr) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].nom_personne_fr
        )
      );
      return false;
    }
    if (!step1Data.prenom_personne_fr) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].prenom_personne_fr
        )
      );
      return false;
    }
    if (!step1Data.nom_personne_ar) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].nom_personne_ar
        )
      );
      return false;
    }
    if (!step1Data.prenom_personne_ar) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].prenom_personne_ar
        )
      );
      return false;
    }
    if (!step1Data.date_naissance) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].date_naissance
        )
      );
      return false;
    }
    if (!step1Data.lieu_naissance_fr) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].lieu_naissance_fr
        )
      );
      return false;
    }
    if (!step1Data.lieu_naissance_ar) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].lieu_naissance_ar
        )
      );
      return false;
    }
    if (!step1Data.nationalite_fr) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].nationalite_fr
        )
      );
      return false;
    }
    if (!step1Data.nationalite_ar) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].nationalite_ar
        )
      );
      return false;
    }
    ...
    if (!step1Data.adresse_fr) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].adresse_fr
        )
      );
      return false;
    }
    if (!step1Data.adresse_ar) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].adresse_ar
        )
      );
      return false;
    }
    if (!step1Data.sexe_personne_fr) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].sexe_personne_fr
        )
      );
      return false;
    }
    if (!step1Data.sexe_personne_ar) {
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].sexe_personne_ar
        )
      );
      return false;
    }
    ...
    if (
      ...
      setError(
        translations[langue].required.replace(
          ":attribute",
          translations[langue].carte_nationale
        )
      );
      return false;
    }
  ...
  const nextStep = async (e) => {
    ...
    if (step === 1) {
      ...
      try {
        ...
        setError(
          error.message ||
            translations[langue].required.replace(":attribute", "soumission")
        );
      }
    } else if (step === 2) {
  ...
  <ol
    className={`flex items-center w-full text-sm font-medium text-center text-gray-500 dark:text-gray-400 sm:text-base ${
      direction === "rtl" ? "flex-row-reverse space-x-reverse space-x-6" : "flex-row space-x-6"
    }`}
  ...
  >
    ...
    <li
      className={`flex md:w-full items-center ${
        ...
        direction === "rtl" ? "after:mr-8 xl:after:mr-12" : "after:ml-8 xl:after:ml-12"
