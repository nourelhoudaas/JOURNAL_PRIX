...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : jeu. 31 juil. 2025 à 09:30
...
(1, 'houda', 'sayahhouda06@gmail.com', '$2y$12$dynwwo7c9BU/NFEFOo5/xOytKLEhkCeTMUwNXX04ZIdyjxA2ymaby', '379240', 'verifié', '405401', '2025-07-28 13:13:48', NULL, '2025-07-28 13:14:23', 1);
...
INSERT INTO `dossiers` (`id_dossier`, `date_create_dossier`, `statut_dossier`, `id_fichier`, `id_personne`) VALUES
(1, '2025-07-28 13:23:07', 'En cours', 1, 4);
...
INSERT INTO `fichiers` (`id_fichier`, `nom_fichier_ar`, `nom_fichier_fr`, `file_path`, `type`, `size`, `date_upload`) VALUES
(1, 'carte_nationale', 'carte_nationale', 'fichiers/nzsaHkrntFq9uay96dC3WQDTFWFykYaL1MOTjgRY.pdf', 'carte_nationale', 20570, '2025-07-28 13:23:07');
...
(27, '2025_07_23_091518_create_travailles_table', 1),
...
INSERT INTO `personnes` (`id_personne`, `id_nin_personne`, `nom_personne_ar`, `nom_personne_fr`, `prenom_personne_ar`, `prenom_personne_fr`, `date_naissance`, `lieu_naissance_ar`, `lieu_naissance_fr`, `nationalite_ar`, `nationalite_fr`, `id_professional_card`, `num_tlf_personne`, `adresse_ar`, `adresse_fr`, `fonction_ar`, `fonction_fr`, `sexe_personne_ar`, `sexe_personne_fr`, `groupage`, `photo_path`, `id_compte`) VALUES
(4, 121212, 'k', 'k', 'jhf', 'jhf', '2000-02-22', 'ss', 'ss', 'sss', 'ss', NULL, '0791326438', 'sss', 'cité 1200 logts boumerdes', NULL, NULL, 'sss', 'sss', 'sss', 'photos/LgOwELYZfZZQbpkZWBvUiOKkPOjequhj8vs0jBVe.png', 1);
...
CREATE TABLE IF NOT EXISTS `travaille` (
  ...
  `num_asset` bigint UNSIGNED NOT NULL,
  `id_etab` bigint UNSIGNED NOT NULL,
  `id_personne` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `travaille_num_asset_unique` (`num_asset`),
  KEY `travaille_id_etab_foreign` (`id_etab`),
  KEY `travaille_id_personne_foreign` (`id_personne`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'houda', 'sayahhouda06@gmail.com', NULL, '$2y$12$dynwwo7c9BU/NFEFOo5/xOytKLEhkCeTMUwNXX04ZIdyjxA2ymaby', NULL, NULL, NULL, NULL, '2025-07-28 12:13:48', '2025-07-28 12:13:48', NULL);
