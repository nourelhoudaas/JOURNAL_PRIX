...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 13 août 2025 à 13:44
...
('5c785c036466adea360111aa28563bfd556b5fba', 'i:4;', 1755092003),
('5c785c036466adea360111aa28563bfd556b5fba:timer', 'i:1755092003;', 1755092003),
('b0d987831f07a96453013f6d685dc1fd', 'i:1;', 1755073342),
('b0d987831f07a96453013f6d685dc1fd:timer', 'i:1755073342;', 1755073342);
...
(1, 'Admin', 'sayahhouda06@gmail.com', '$2y$12$EQH8n0la1rawfHulP9jOiOcDF5ntGCR/9LuffkUn4pheJ3l5Oh4R2', 'ABC123', 'verifie', '', '2025-08-06 12:41:03', NULL, '2025-08-06 12:41:03', 1);
...
(1, '2025-08-06 12:42:17', 'en_attente');
...
INSERT INTO `etablissement` (`id_etab`, `nom_ar_etab`, `nom_fr_etab`, `email_etab`, `tel_etab`, `id_secteur`, `id_cat_etat`, `langue`, `tv`, `radio`, `media`, `id_type_media`, `id_specialite`, `created_at`, `updated_at`) VALUES
(1, 'sayah', 'nour el houda', 'sayahhouda06@gmail.com', '0791326438', 2, 1, '', NULL, 'locale', NULL, 2, 3, '2025-08-10 12:20:31', '2025-08-12 11:34:21');
...
CREATE TABLE IF NOT EXISTS `fichiers` (
  ...
  `id_oeuvre` bigint UNSIGNED DEFAULT NULL,
  `date_upload` datetime NOT NULL,
  PRIMARY KEY (`id_fichier`),
  KEY `fichiers_id_dossier_foreign` (`id_dossier`),
  KEY `fichiers_id_oeuvre_foreign` (`id_oeuvre`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'contrats_actifs.pdf', 'contrats_actifs.pdf', 'carte_nationale/b3vaSzWicTLdhJuyaw9Vy222F4MNK1ytwTk27Ox5.pdf', 'carte_nationale', 402121, 1, NULL, '2025-08-10 14:38:49'),
(2, '_d520cc28-bd20-4860-af2d-6b4ac3986835_03722.jpg', '_d520cc28-bd20-4860-af2d-6b4ac3986835_03722.jpg', 'photos/qpmUeoxAcYItrzGGnWDiyTKUgvN8cbFCCYruD5Tz.jpg', 'photo', 7892, 1, NULL, '2025-08-06 12:47:29'),
(3, 'شهادة عمل', 'Attestation de travail', 'attestations_travail/SSbzUSLhnZI04NLQp4yE1pu8WzkGzHxq7AYufvwN.pdf', 'attestation_travail', 111725, 1, NULL, '2025-08-12 12:34:21');
...
(16, '2025_07_09_103712_create_travails_table', 1),
(17, '2025_07_09_103713_create_fichiers_table', 1),
...
(1, '2025-08-12', 1, 1, 3, '88', '2025-08-10 12:20:31', '2025-08-12 11:34:21');
...
(1, 123456789012345678, 'qak', 'kqa', 'qas', 'sqa', '2025-08-02', 'الجلفة', 'Jijel', 'جزائرية', 'Algerienne', 96524, 1, '0791326439', 'aqsss', 'cité 1200 logts boumerdesssaa', 'ss', 'ss', 'ذكر', 'Masculin', 'A+', '2025-08-06 11:42:17', '2025-08-12 11:34:21', 1);
...
(1, 'Admin', 'sayahhouda06@gmail.com', '2025-08-06 11:41:03', '$2y$12$gq98qZef/WvChLExGCirMe60EmXi4xyGed3uu/EgQTy.DvVCPTvnu', NULL, NULL, NULL, NULL, '2025-08-06 11:41:03', '2025-08-06 11:41:03', NULL);
...
ALTER TABLE `fichiers`
  ...
  ADD CONSTRAINT `fichiers_id_oeuvre_foreign` FOREIGN KEY (`id_oeuvre`) REFERENCES `travails` (`id_oeuvre`) ON DELETE CASCADE;
