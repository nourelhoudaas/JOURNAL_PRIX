...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mar. 05 août 2025 à 11:07
...
CREATE TABLE IF NOT EXISTS `participer` (
  ...
  `id_oeuvre` int NOT NULL,
  `id_equipe` int NOT NULL,
  `date_creation_oeuvre` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_participer`),
  KEY `contients_id_oeuvre_foreign` (`id_oeuvre`),
  KEY `contients_id_equipe_foreign` (`id_equipe`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(31, '2025_08_04_143142_create_participer_table', 1);
