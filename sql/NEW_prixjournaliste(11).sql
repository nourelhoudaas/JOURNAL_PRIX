...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : mer. 06 août 2025 à 07:45
...
INSERT INTO `appartients` (`id_appartient`, `id_edition`, `id_theme`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 1),
...
CREATE TABLE IF NOT EXISTS `associes` (
  `id_associe` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `associes` (`id_associe`, `id_oeuvre`, `id_theme`) VALUES
(1, 1, 1),
(2, 2, 2);
...
('b0d987831f07a96453013f6d685dc1fd', 'i:1;', 1754465982),
('b0d987831f07a96453013f6d685dc1fd:timer', 'i:1754465982;', 1754465982);
...
(1, 'Admin', 'sayahhouda06@gmail.com', '$2y$12$hikqUgPRjhxyBIgy7M0bm.N1opotwoCWtZ2P0Vvm63/4u0EAQ0fyy', 'ABC123', 'verifie', '', '2025-08-05 22:08:24', NULL, '2025-08-05 22:08:24', 1),
(2, 'testuser', 'test@example.com', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'TEST123', 'verifie', '', '2025-08-05 23:08:37', NULL, '2025-08-05 23:08:37', 2);
...
CREATE TABLE IF NOT EXISTS `contients` (
  `id_contient` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `id_oeuvre` bigint UNSIGNED NOT NULL,
...
INSERT INTO `contients` (`id_contient`, `id_oeuvre`, `id_categorie`, `annee_gain`, `classement`, `created_at`, `updated_at`) VALUES
(1, 1, 1, '2025-04-01', 2, '2025-08-05 22:08:37', '2025-08-05 22:08:37'),
(2, 2, 2, '2024-04-01', 1, '2025-08-05 22:08:37', '2025-08-05 22:08:37');
...
(1, '2025-05-15 10:00:00', 'actif'),
(2, '2025-05-16 11:00:00', 'actif');
...
INSERT INTO `editions` (`id_edition`, `annee_edition`, `num_edition`, `date_lancement_edition`, `date_limite_depotDossier`, `statut_edition`) VALUES
(1, '2025-01-01', 1, '2025-01-01', '2025-06-30', 'active'),
(2, '2024-01-01', 2, '2024-01-01', '2024-06-30', 'inactive'),
(3, '2023-01-01', 3, '2023-01-01', '2023-06-30', 'inactive');
...
INSERT INTO `fichiers` (`id_fichier`, `nom_fichier_ar`, `nom_fichier_fr`, `file_path`, `type`, `size`, `id_dossier`, `date_upload`) VALUES
(1, 'ملف العمل 1', 'Fichier travail 1', '/uploads/travail1.pdf', 'pdf', 1024, 1, '2025-05-15 10:05:00'),
(2, 'ملف العمل 2', 'Fichier travail 2', '/uploads/travail2.pdf', 'pdf', 2048, 2, '2025-05-16 11:05:00');
...
CREATE TABLE IF NOT EXISTS `forme` (
  ...
  `id_personne` bigint UNSIGNED NOT NULL,
  `date_forme_equipe` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `situation_forme_equipe` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
...
(10, '2025_07_09_103559_create_peut_etre_participants_table', 1),
(11, '2025_07_09_103560_create_peut_etre_juries_table', 1),
...
(31, '2025_08_05_141220_create_participers_table', 1);
...
CREATE TABLE IF NOT EXISTS `participer` (
  `id_participer` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
  `id_oeuvre` bigint UNSIGNED NOT NULL,
  `id_equipe` bigint UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`id_participer`),
  KEY `participer_id_oeuvre_foreign` (`id_oeuvre`),
  KEY `participer_id_equipe_foreign` (`id_equipe`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 123456789012345678, 'اسم العائلة', 'Nom de famille', 'الاسم الشخصي', 'Prénom', '1990-01-01', 'الجزائر', 'Alger', 'جزائرية', 'Algérienne', NULL, 1, '0555555555', 'عنوان', 'Adresse', 'صحفي', 'Journaliste', 'ذكر', 'Homme', 'A+', '2025-08-05 22:08:37', '2025-08-05 22:08:37', 2);

-- --------------------------------------------------------

--
-- Structure de la table `peut_etre_juries`
--

DROP TABLE IF EXISTS `peut_etre_juries`;
...
--
-- Structure de la table `peut_etre_participants`
--

DROP TABLE IF EXISTS `peut_etre_participants`;
CREATE TABLE IF NOT EXISTS `peut_etre_participants` (
...
INSERT INTO `specialite` (`id_specialite`, `name_ar`, `name_fr`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `travails` (
  `id_oeuvre` bigint UNSIGNED NOT NULL AUTO_INCREMENT,
...
INSERT INTO `travails` (`id_oeuvre`, `titre_oeuvre_ar`, `titre_oeuvre_fr`, `Duree_nbr_signes`, `date_publication`, `description_oeuvre_ar`, `description_oeuvre_fr`, `statut_oeuvre_ar`, `statut_oeuvre_fr`, `valider_oeuvre`, `id_fichier`, `created_at`, `updated_at`) VALUES
(1, 'عمل إعلامي 1', 'Oeuvre médiatique 1', '00:30:00', '2025-03-01', 'وصف العمل 1', 'Description oeuvre 1', 'نشط', 'actif', 'oui', 1, '2025-08-05 22:08:37', '2025-08-05 22:08:37'),
(2, 'عمل إعلامي 2', 'Oeuvre médiatique 2', '00:45:00', '2024-03-01', 'وصف العمل 2', 'Description oeuvre 2', 'نشط', 'actif', 'oui', 2, '2025-08-05 22:08:37', '2025-08-05 22:08:37');
...
(1, 'تلفزيون', 'TV', 1, '2025-08-05 21:08:24', '2025-08-05 21:08:24'),
(2, 'راديو', 'Radio', 1, '2025-08-05 21:08:24', '2025-08-05 21:08:24'),
(3, 'مكتوب', 'Écrit', 2, '2025-08-05 21:08:24', '2025-08-05 21:08:24'),
(4, 'إلكتروني', 'Électronique', 2, '2025-08-05 21:08:24', '2025-08-05 21:08:24'),
(5, 'خاص', 'Privé', 3, '2025-08-05 21:08:24', '2025-08-05 21:08:24');
...
(1, 'Admin', 'sayahhouda06@gmail.com', '2025-08-05 21:08:23', '$2y$12$4.hWmbMXAu6wyvVxcX2lgO0F6xK2SOoy40GDDKKuaKbjYwxLEM9k6', NULL, NULL, NULL, NULL, '2025-08-05 21:08:23', '2025-08-05 21:08:23', NULL),
(2, 'Test User', 'test@example.com', NULL, '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', NULL, NULL, NULL, NULL, '2025-08-05 22:08:37', '2025-08-05 22:08:37', NULL);
...
ALTER TABLE `etablissement`
  ADD CONSTRAINT `etablissement_id_specialite_foreign` FOREIGN KEY (`id_specialite`) REFERENCES `specialite` (`id_specialite`) ON DELETE CASCADE,
...
ALTER TABLE `occuper`
  ...
  ADD CONSTRAINT `occuper_id_fichier_foreign` FOREIGN KEY (`id_fichier`) REFERENCES `fichiers` (`id_fichier`) ON DELETE CASCADE,
...
ALTER TABLE `participer`
  ADD CONSTRAINT `participer_id_equipe_foreign` FOREIGN KEY (`id_equipe`) REFERENCES `equipes` (`id_equipe`) ON DELETE CASCADE,
  ADD CONSTRAINT `participer_id_oeuvre_foreign` FOREIGN KEY (`id_oeuvre`) REFERENCES `travails` (`id_oeuvre`) ON DELETE CASCADE;
...
ALTER TABLE `personnes`
  ...
  ADD CONSTRAINT `personnes_id_dossier_foreign` FOREIGN KEY (`id_dossier`) REFERENCES `dossiers` (`id_dossier`) ON DELETE CASCADE;

--
-- Contraintes pour la table `peut_etre_juries`
--
ALTER TABLE `peut_etre_juries`
...
--
-- Contraintes pour la table `peut_etre_participants`
--
ALTER TABLE `peut_etre_participants`
